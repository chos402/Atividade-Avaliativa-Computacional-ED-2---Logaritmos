...
function atualizarDashboard() {
    ...
    const medicos = profissionais.filter(p => p.cargo === "Médico");
    const enfermeiros = profissionais.filter(p => p.cargo === "Enfermeiro");

    document.getElementById("totalProfissionais").innerText = ativos.length;
    document.getElementById("totalMedicos").innerText = medicos.length;
    document.getElementById("totalEnfermeiros").innerText = enfermeiros.length;
}
